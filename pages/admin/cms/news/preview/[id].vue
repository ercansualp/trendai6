<template>
  <div class="container mx-auto py-8 px-4">
    ...
    <div v-else-if="!newsItem" class="card p-12 text-center">
      ...
      <NuxtLink to="/admin/cms/news" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium border border-input rounded-md text-foreground bg-background hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition-colors duration-200">
    ...
    <div v-else class="card p-6 flex flex-col">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
        <div class="flex items-center mb-4 md:mb-0">
          <NuxtLink to="/admin/cms/news" class="inline-flex items-center px-3 py-2 text-sm font-medium border border-input rounded-md text-foreground bg-background hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition-colors duration-200 mr-2 md:mr-4">
        ...
        <div class="flex flex-wrap gap-2 justify-end">
          <NuxtLink :to="`/admin/cms/news/edit/${newsItem.id}`" class="inline-flex items-center px-3 py-2 text-sm font-medium border border-input rounded-md text-foreground bg-background hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition-colors duration-200">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="mt-8 pt-6 border-t border-border flex justify-end">
        <NuxtLink to="/admin/cms/news" class="inline-flex items-center px-4 py-2 text-sm font-medium border border-input rounded-md text-foreground bg-background hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition-colors duration-200">
          <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
          </svg>
          Haber Yönetimine Geri Dön
