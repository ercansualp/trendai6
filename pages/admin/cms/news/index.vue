      ...
      <div class="card p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          ...
          <div class="flex space-x-2 col-span-full md:col-span-2">
            ...
            <NuxtLink to="/admin/cms/news/add" class="inline-flex items-center justify-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors duration-200 w-full">
...
const editNews = (newsItem) => {
  ...
  navigateTo(`/admin/cms/news/edit/${newsItem.id}`)
}

const previewNews = (newsId) => {
  // Navigate to preview page
  navigateTo(`/admin/cms/news/preview/${newsId}`)
}
