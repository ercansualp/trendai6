<template>
  <div class="min-h-screen bg-background">
        ...
        <div class="px-4 space-y-2">
          ...
          <div v-if="isChatbotSubmenuOpen" class="ml-8 mt-2 space-y-1">
            ...
            <NuxtLink
              ...
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/chatbot/settings' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            class="flex items-center px-4 py-3 text-secondary-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors group"
            :class="{ 'bg-accent text-accent-foreground': isCmsSubmenuOpen || $route.path.startsWith('/admin/cms') }"
          >
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div v-if="isCmsSubmenuOpen" class="ml-8 mt-2 space-y-1">
            <NuxtLink
              to="/admin/cms/authors"
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/cms/authors' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
            ...
            <NuxtLink
              to="/admin/cms/sources"
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/cms/sources' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NuxtLink
              ...
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/cms/categories' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NuxtLink
              to="/admin/cms/tags"
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/cms/tags' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NuxtLink
              to="/admin/cms/news"
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/cms/news' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NuxtLink
              to="/admin/cms/news/add"
              class="flex items-center px-4 py-2 text-sm text-muted-foreground rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors"
              :class="{ 'bg-accent text-accent-foreground': $route.path === '/admin/cms/news/add' }"
              @click="closeSidebarOnMobile"
            >
              <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{ 'lg:ml-64': isSidebarOpen }" class="flex flex-col min-h-screen">
      <!-- Header -->
      <header class="fixed top-0 left-0 right-0 bg-card shadow-lg border-b border-border rounded-b-xl z-30" :class="{ 'lg:ml-[255.2px]': isSidebarOpen }">
...
onMounted(() => {
  ...
  isUserManagementSubmenuOpen.value = route.path.startsWith('/admin/users');
  isCmsSubmenuOpen.value = route.path.startsWith('/admin/cms');
...
watch(() => route.path, (newPath) => {
  ...
  const isChatbotSection = newPath.startsWith('/admin/chatbot');
  if (isChatbotSection) {
  ...
  const isUserManagementSection = newPath.startsWith('/admin/users');
  ...
  // CMS submenu logic
  const isCmsSection = newPath.startsWith('/admin/cms');
  if (isCmsSection) {
...
const getPageTitle = () => {
  ...
  if (path.startsWith('/admin/chatbot/') && path !== '/admin/chatbot/chat' && path !== '/admin/chatbot/settings') return 'Session Details' // New title for dynamic route
  if (path === '/admin/chatbot/chat') return 'Live Chat'
  if (path === '/admin/chatbot/settings') return 'Chatbot Settings' // New title for chatbot settings
  ...
  if (path === '/admin/cms/authors') return 'Yazar Yönetimi' // New title for authors
  if (path === '/admin/cms/sources') return 'Haber Kaynağı Yönetimi' // New title for sources
  if (path === '/admin/cms/categories') return 'Kategori Yönetimi' // New title for categories
  if (path === '/admin/cms/tags') return 'Etiket Yönetimi' // New title for tags
  if (path === '/admin/cms/news') return 'Haber Yönetimi' // New title for news
  if (path === '/admin/cms/news/add') return 'Yeni Haber Ekle' // New title for add news
